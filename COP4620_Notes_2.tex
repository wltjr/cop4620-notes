...
nodes and edges are there? ADD takes 1 cycle. \\
  \begin{tikzpicture}[->, >=stealth', node distance=4cm]
    \node[state, rectangle] (1) {a = b + c};
    \node[state, rectangle, right of=1] (2) {d = a + 3};
    \node[state, rectangle, right of=2] (3) {e = f + d};
    \draw[very thick]
...
\begin{multicols}{2}
  ...
  \begin{tikzpicture}[->, >=stealth', node distance=2cm]
    \node[state, rectangle] (7) {\textr{7} ST R6,D};
    \node[state, rectangle, above of=7] (6) {\textr{6} R6 = R3 + R5};
    \node[state, rectangle, above of=6, left of=6] (3) {\textr{3} R3 = R1 + R2};
    \node[state, rectangle, above of=6, right of=6] (5) {\textr{5} R5 = R4 * R2};
    \node[state, rectangle, above of=5, right of=5] (4) {\textr{4} LD C, R4};
    \node[state, rectangle, above of=5, left of=5] (2) {\textr{2} LD B, R2};
    \node[state, rectangle, above of=3, left of=3] (1) {\textr{1} LD A, R1};
    \draw[very thick]
...
\end{tabular}
  \vfill\columnbreak
  \setlength{\leftskip}{-13em}
  \begin{tikzpicture}[->, >=stealth', node distance=2.5cm]
    \node[state, rectangle] (10) {\textr{10} ST R9, D};
    \node[state, rectangle, above of=10, right of=10] (9) {\textr{9} R9 = R7 + R8};
    \node[state, rectangle, above of=10, left of=10] (8) {\textr{8} R8 = R6 + R4};
    \node[state, rectangle, above of=9, right of=9] (7) {\textr{7} R7 = R1 / R4};
    \node[state, rectangle, above of=9, left of=9] (6) {\textr{6} R6 = R5 - R3};
    \node[state, rectangle, above of=8, left of=8] (5) {\textr{5} R5 = R1 + 7};
    \node[state, rectangle, above of=5, right of=5] (4) {\textr{4} R4 = R2 * R1};
    \node[state, rectangle, above of=4, right of=4] (2) {\textr{2} LD B, R2};
    \node[state, rectangle, right of=2, xshift=2.5cm] (3) {\textr{3} LD C, R3};
    \node[state, rectangle, above of=4, left of=4] (1) {\textr{1} LD A, R1};
    \draw[very thick]
      (1) edge[left, left] node{2} (4)
      (1) edge[left, left] node{2} (5)
      (2) edge[left, left] node{2} (4)
      (3) edge[left, left] node{2} (6)
      (4) edge[left, above] node{2} (7)
      (4) edge[left, left] node{2} (8)
      (5) edge[left, left, bend left=30] node{1} (6)
      (6) edge[left, left] node{2} (8)
      (7) edge[left, above] node{3} (9)
      (8) edge[left, above] node{1} (9)
      (9) edge[left, left] node{1} (10);
    \node [annotation, left] at (1.west) {\tikz{\node[gray box=1] {9};}};
    \node [annotation, left] at (2.west) {\tikz{\node[gray box=1] {9};}};
    \node [annotation, left] at (3.west) {\tikz{\node[gray box=1] {7};}};
    ...
    \node [annotation, left] at (6.west) {\tikz{\node[gray box=1] {5};}};
    \node [annotation, left] at (7.west) {\tikz{\node[gray box=1] {5};}};
    \node [annotation, left] at (8.west) {\tikz{\node[gray box=1] {3};}};
    \node [annotation, right] at (9.east) {\tikz{\node[gray box=1] {2};}};
    \node [annotation, left] at (10.west) {\tikz{\node[gray box=1] {1};}};
  \end{tikzpicture} 
\end{multicols}
