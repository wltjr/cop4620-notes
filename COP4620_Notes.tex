...
\begin{multicols}{2}
  ...
  \begin{tikzpicture}
    ...
    \node[very thick, state, shape=rectangle, above of=1, right of=1] (5) {
    \makecell[l] {
    State 5\\
    \hline
    ...
    \node[very thick, state, shape=rectangle, below of=5] (6) {
    \makecell[l] {
    State 6 R(5)\\
    \hline
    T $\rightarrow$ (E)\textbf{.}
    ...
    \node[very thick, state, shape=rectangle, below of=7] (8) {
    \makecell[l] {
    State 8\\
    \hline
